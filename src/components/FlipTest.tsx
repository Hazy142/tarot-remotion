...
export type FlipTestProps = z.infer<typeof flipTestSchema> & {
    children?: React.ReactNode; // Overlay (TarotOverlay) als Child
};
    ...
    return (
        <AbsoluteFill style={{ backgroundColor: '#1a1525' }}>
            ...
            <AbsoluteFill style={{
                ...
                {/* Background Layer — behind everything, follows camera */}
                ...
                {/* Overlay Layer (TarotOverlay oder fallback zu Template) */}
